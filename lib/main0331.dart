                ...
                children: [
                  ...
                  Center(
                    child: Row(
                        ...
                        children: [
                          Flexible(flex: 22, child:TextButton(style: TextButton.styleFrom(backgroundColor:Colors.black),
                    onPressed: () {},
                      child: Center(
                              child: Text(
                                  'size(py)'.toUpperCase(),
                                  style: const TextStyle(
                                      ...
                                      fontWeight: FontWeight.bold))))),
                          Flexible(flex: 12,
                              child: TextButton(style: TextButton.styleFrom(backgroundColor:Colors.black),
                                  onPressed: () {},
                                  child: Center(
                                      child: Text(
                                    'best'.toUpperCase(),
